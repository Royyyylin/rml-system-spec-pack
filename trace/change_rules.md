...
| :--- | :--- | :--- | :--- |
| `CIR-001` | feature spec (FEA-NNN / F-NN) changed | `05_quality-acceptance/requirements.md` | `app-spec/architecture.md`, `05_quality-acceptance/ac-catalog.md` |
| `CIR-002` | `REQ-*` changed | related block / state / sequence / packet docs, `trace_map.yaml`, AC, TC | `impact-summary.md` |
| `CIR-003` | `ble_api.yaml` changed | `firmware-spec/packet_contract.md`, packet diagram, affected sequence / AC / TC | `05_quality-acceptance/requirements.md`, `app-spec/architecture.md` |
| `CIR-004` | identity boundary changed (`stableId` / `central_ref` / MAC) | `00_introduction-goals/system-intent.md`, `05_quality-acceptance/requirements.md`, `app-spec/architecture.md`, `trace_map.yaml` | AC / TC / impact summary |
| `CIR-005` | assignment or Central ownership policy changed | `app-spec/architecture.md`, `app-spec/state_machine.md`, `app-spec/sequence_flows.md`, AC / TC | `00_introduction-goals/system-intent.md`, `trace_map.yaml` |
| `CIR-006` | alias precedence changed | `05_quality-acceptance/requirements.md`, `app-spec/architecture.md`, AC / TC | `app-spec/state_machine.md`, `trace_map.yaml` |
